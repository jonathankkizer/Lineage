...
create or replace transient table dw_dev.dev_jkizer.intmdt_person_input
    copy grants
    
    
    as (-- NOTE: THIS TABLE IS USED AS INPUT FOR Suvida ID Python process don't make changes unless intended
with data as (
select
	dmp.member_id,
...
select
	...
	phone,
	src_file_name as _last_sync_date
