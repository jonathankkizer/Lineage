...
create or replace transient table dw_dev.dev_jkizer.intmdt_zentake_airbyte_form
    copy grants
    
    
    as (-- 
-- Intermediate model joining Zentake Airbyte staging tables and applying question/answer concept standardization.
-- Table grain is one row per response per question per answer choice.
-- Source data begins 3/27/2026.
--
...
with standardize_question as (
    ...
    from dw_dev.dev_jkizer_staging.stg_zentake_airbyte_responses r
    inner join dw_dev.dev_jkizer_staging.stg_zentake_airbyte_response_details d
