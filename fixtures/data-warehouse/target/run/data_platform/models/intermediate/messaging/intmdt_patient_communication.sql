...
talkdesk as (
    ...
    select
        ...
        case
            ...
            when c.type = 'outound_missed' then 'Outbound'
    ...
    from dw_dev.dev_jkizer_staging.stg_talkdesk_call c
    qualify row_number() over (partition by c.callsid order by c.start_at desc) = 1
),
