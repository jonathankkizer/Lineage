...
create or replace transient table dw_dev.dev_jkizer.dim_pmpm_location_denominator
    copy grants
    
    
    as (-- breaking best practices here to force PMPM denominator work for Finance 
