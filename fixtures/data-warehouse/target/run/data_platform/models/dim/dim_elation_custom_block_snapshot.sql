...
create or replace transient table dw_dev.dev_jkizer.dim_elation_custom_block_snapshot
    copy grants
    
    
    as (-- Table grain is one row per version of question and answering pairing per custom block/template 
