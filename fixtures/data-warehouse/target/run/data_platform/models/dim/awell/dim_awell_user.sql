...
create or replace transient table dw_dev.dev_jkizer.dim_awell_user
    copy grants
    
    
    as (--Staff with at least one action in Awell will appear, join back to Rippling by work email
