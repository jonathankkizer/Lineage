...
create or replace transient table dw_dev.dev_jkizer.fct_patient_provider
    copy grants
    
    
    as (with provider_data as ( -- combine elation-listed provider information w/ dim_provider to pull in latest assigned and primary provider information
	select
		siw.suvida_id,
		ep.elation_id,
		ep.source,
