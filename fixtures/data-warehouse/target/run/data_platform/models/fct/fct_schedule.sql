...
create or replace transient table dw_dev.dev_jkizer.fct_schedule
    copy grants
    
    
    as (with week_day_status as ( /*Create a week record for each day of the week in the configuration*/
     select
        schedule_id,
        1 as day_of_week,
