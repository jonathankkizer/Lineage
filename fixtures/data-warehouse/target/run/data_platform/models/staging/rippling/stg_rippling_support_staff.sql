  ...
  create or replace   view dw_dev.dev_jkizer_staging.stg_rippling_support_staff
...
where (npi_number is null or trim(npi_number) = '') and map.warehouse = 'support_staff'
  );
