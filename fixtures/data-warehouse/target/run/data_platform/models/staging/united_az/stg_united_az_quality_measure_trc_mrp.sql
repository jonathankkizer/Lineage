  ...
  create or replace   view dw_dev.dev_jkizer_staging.stg_united_az_quality_measure_trc_mrp
  ...
  as (
	...
	select 
		...
		'TRC - Medication Reconciliation Post-Discharge' as measure_display_name,
