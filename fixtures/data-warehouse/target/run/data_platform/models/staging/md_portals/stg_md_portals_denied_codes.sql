  ...
  create or replace   view dw_dev.dev_jkizer_staging.stg_md_portals_denied_codes
  ...
  as (
    ...
    coalesce(replace(icd_codes.value:hccCategory, '"', ''), NULL) as hcc,
    ...
    codes:"Denied ICD-10 Codes" as denied_codes_array
from source_prod.mdportals.suspects,
LATERAL FLATTEN(input => codes:"Denied ICD-10 Codes") as hcc_entries,
