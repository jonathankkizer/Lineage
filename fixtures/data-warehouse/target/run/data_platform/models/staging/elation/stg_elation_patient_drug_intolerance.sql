  ...
  create or replace   view dw_dev.dev_jkizer_staging.stg_elation_patient_drug_intolerance
  ...
  as (
    select
    UQ_PATIENT_DRUG_INTOLERANCE as uq_patient_drug_intolerance,
    ID as patient_drug_intolerance_id,
...
from elationhealth_ehdw_azure_scentralus_texas_elation_suvida_snowflake_secure_share.suvida.patient_drug_intolerance
  );
