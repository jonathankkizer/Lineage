  ...
  create or replace   view dw_dev.dev_jkizer_staging.stg_closedloop_model_readmissions_predictions
  ...
  as (
    ...
    run_datetime
from source_prod.closedloop.src_model_readmissions_predictions
  );
