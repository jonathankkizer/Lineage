  ...
  create or replace   view dw_dev.dev_jkizer.int_elation_census_message
  
    
    
(
  
    "CENSUS_EVENT_ID" COMMENT $$$$, 
  
    "SUVIDA_ID" COMMENT $$$$, 
  
    "ADMIT_DATE" COMMENT $$$$, 
  
    "LEVEL_OF_CARE" COMMENT $$$$, 
  
    "FACILITY" COMMENT $$$$, 
  
    "ATTENDING_PHYSICIAN" COMMENT $$$$, 
  
    "DISCHARGE_DATE" COMMENT $$$$, 
  
    "EARLIEST_REPORT_DATE" COMMENT $$$$, 
  
    "EARLIEST_DISCHARGE_REPORT_DATE" COMMENT $$$$, 
  
    "MAX_REPORT_DATE" COMMENT $$$$, 
    ...
    "DATA_SOURCES" COMMENT $$$$, 
  
    "DATA_SOURCE_TYPES" COMMENT $$$$
