  ...
  create or replace   view dw_dev.dev_jkizer.hcc_gap_roster
  
    
    
(
  
    "ELATION_ID" COMMENT $$The EMR (Elation) identifier of the patient$$, 
  
    "DEFINITION_ID" COMMENT $$The Quality Care Gap Elation definition ID$$, 
  
    "CAREGAP_ID" COMMENT $$The EMR (Elation) Care Gap ID$$, 
  
    "PRACTICE_ID" COMMENT $$The EMR (Elation) practice ID$$, 
    ...
    "PROVIDER_NPI" COMMENT $$The NPI of the patient's PCP$$
