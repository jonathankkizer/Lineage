  ...
  create or replace   view dw_dev.dev_jkizer.emergency_communications
...
(
    ...
    "PRECEDENCE_RANK" COMMENT $$$$, 
  
    "PREFERENCE_RANK" COMMENT $$$$, 
    ...
    "DO_NOT_CONTACT" COMMENT $$$$, 
  
    "MARKET_NAME" COMMENT $$$$, 
  
    "LOCATION_NAME" COMMENT $$$$, 
  
    "LOCATION_STATE" COMMENT $$$$, 
