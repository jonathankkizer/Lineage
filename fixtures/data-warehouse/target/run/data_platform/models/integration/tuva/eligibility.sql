...
create or replace transient table tuva_dev.dev_jkizer_input_layer.eligibility
    copy grants
    
    
    as (with assignment as ( -- pull min and max regardless of gaps; always join back to patient assignment for membership source of truth
	select 
		suvida_id,
