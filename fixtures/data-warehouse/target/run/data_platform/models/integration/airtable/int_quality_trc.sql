...
create or replace transient table dw_dev.dev_jkizer.int_quality_trc
    copy grants
	...
	from census_admits
	where year(greatest_ignore_nulls(inpatient_first_discharge_date, inpatient_second_discharge_date, inpatient_third_discharge_date, inpatient_fourth_discharge_date, er_visit_date)) = 2025 -- manually set for 2025; will have to update w/ new measure year (candidate for CLEANUP/variable)
)
select
	census_quality_grouping_id,
	my.suvida_id,
