...
create or replace transient table dw_dev.dev_jkizer.int_med_adherence_2026
    copy grants
    
    
    as (-- Airtable base: Pharmacy Quality Operations (2026)
...
where measure_year = '2026-01-01' -- manually set measure year
