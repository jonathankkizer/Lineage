...
create or replace transient table dw_dev.dev_jkizer.int_patient_measure_count
    copy grants
...
left join (
	...
	from (
		...
		from dw_dev.dev_jkizer.int_patient_med_adherence
		where
...
left join (
	...
	from dw_dev.dev_jkizer.int_patient_attestation_opportunity
	where
        attestation_opportunity_status <> 'closed' and
        measure_year = year(sysdate())
	group by suvida_id
