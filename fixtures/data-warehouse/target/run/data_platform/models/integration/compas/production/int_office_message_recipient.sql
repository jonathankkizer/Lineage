...
create or replace transient table dw_dev.dev_jkizer.int_office_message_recipient
    copy grants
    ...
    seomr.status,
    seomr.ack_datetime as datetime_acknowledged
from dw_dev.dev_jkizer_staging.stg_elation_office_messages_recipients seomr
left join dw_dev.dev_jkizer.int_office_message iom
