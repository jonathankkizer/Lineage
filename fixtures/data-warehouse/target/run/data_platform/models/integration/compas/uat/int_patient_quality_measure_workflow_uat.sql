...
create or replace transient table dw_dev.dev_jkizer.int_patient_quality_measure_workflow_uat
    copy grants
...
left join dw_dev.dev_jkizer.int_patient_quality_measure_uat qms
