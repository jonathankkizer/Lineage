...
create or replace transient table dw_dev.dev_jkizer.int_patient_problem
    copy grants
    ...
    select
        ...
        p.rank,
        pc.icd10
    from dw_dev.dev_jkizer.int_patient_summary ps
...
left join dw_dev.dev_jkizer_staging.stg_elation_visit_note vn
    on ps.elation_id = to_varchar(vn.patient_id)
...
left join dw_dev.dev_jkizer.fct_appointment fa
    on vn.patient_id = fa.elation_id and
