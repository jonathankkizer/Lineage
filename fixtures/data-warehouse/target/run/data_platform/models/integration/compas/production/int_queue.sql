...
create or replace transient table dw_dev.dev_jkizer.int_queue
    copy grants
    ...
    to_varchar(thread_id) as queue_item_parent_id,
    ...
    deletion_datetime
from dw_dev.dev_jkizer.int_office_message
where _idx = 1
...
select
    ...
    deletion_datetime
from dw_dev.dev_jkizer.int_report
    )
;
