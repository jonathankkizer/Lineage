...
create or replace transient table dw_dev.dev_jkizer.int_patient_med_adherence_sandbox
    copy grants
    ...
    'Test Doctor' as prescriber_name,
    pma.prescriber_user_id,
    '111 (222)-3333' as prescriber_phone,
    pma.last_fill_date,
    ...
    pma.first_fill_date,
    pma.number_of_fills,
    'Test Pharmacy' as pharmacy_name,
    '111 (222)-3333' as pharmacy_phone,
    '123 Somewhere Blvd' as pharmacy_address,
    pma.measure_source,
    pma.measure_weight,
...
left join dw_dev.dev_jkizer.int_patient_summary_sandbox ipss
    on md5(cast(coalesce(cast(pma.suvida_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) = ipss.suvida_id
where
