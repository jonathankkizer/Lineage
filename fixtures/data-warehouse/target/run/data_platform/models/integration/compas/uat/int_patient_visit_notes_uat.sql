...
create or replace transient table dw_dev.dev_jkizer.int_patient_visit_notes_uat
    copy grants
...
inner join dw_dev.dev_jkizer.int_patient_summary_uat ips
...
where
    ...
    svn._is_test_patient = FALSE and
