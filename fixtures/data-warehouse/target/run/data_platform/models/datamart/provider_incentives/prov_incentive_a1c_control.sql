...
create or replace transient table dw_dev.dev_jkizer.prov_incentive_a1c_control
    copy grants
    
    
    as (with dm_payer_patients as ( -- grab denominator of patients and current payer status from quality gap files
	select
		suvida_id,
