...
create or replace transient table dw_dev.dev_jkizer.clinical_class_mh_p
    copy grants
...
with base_appointments as (
    ...
    where appointment_type like '%MH P:%'
...
select
    ...
    case when fpt.tag_value = 'MH-P' then tag_value else null end as tag_value,
