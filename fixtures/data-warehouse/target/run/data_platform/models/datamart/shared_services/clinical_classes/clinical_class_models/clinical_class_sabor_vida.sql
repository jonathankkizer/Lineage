...
create or replace transient table dw_dev.dev_jkizer.clinical_class_sabor_vida
    copy grants
...
with base_appointments as (
    select
        ...
        case when appointment_type_category = '¡Viva el Bienestar!' then '¡Sabor y Vida!'
            else appointment_type_category
                end as program,
        'Sabor y Vida/Flavor of Life' as class_name,
    ...
    where (appointment_type_category = '¡Viva el Bienestar!' or appointment_type_category = '¡Sabor y Vida!')
...
select
    ...
    case when fpt.tag_value = 'Viva El Bienestar' or fpt.tag_value = 'Sabor y Vida'
        then fpt.tag_value
            end as tag_value,
...
left join dw_dev.dev_jkizer.fct_patient_tag fpt
    ...
    and (fpt.tag_value = 'Viva El Bienestar' or fpt.tag_value = 'Sabor y Vida')
