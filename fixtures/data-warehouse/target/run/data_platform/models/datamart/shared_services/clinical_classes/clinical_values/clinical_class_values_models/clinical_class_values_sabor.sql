...
create or replace transient table dw_dev.dev_jkizer.clinical_class_values_sabor
    copy grants
...
with clinical_values_all as (
    select
        ...
        value_type,
        value
    from dw_dev.dev_jkizer.clinical_class_sabor_vida ccc
