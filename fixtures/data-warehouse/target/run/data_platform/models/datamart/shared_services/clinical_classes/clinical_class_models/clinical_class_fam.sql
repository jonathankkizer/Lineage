...
create or replace transient table dw_dev.dev_jkizer.clinical_class_fam
    copy grants
...
with base_appointments as (
    select
        ...
        'Food As Medicine' as class_name,
    ...
    where lower(appointment_type_category) like 'food as medicine%'
...
select
    ...
    'Food as Medicine Class' as tag_value,
...
left join dw_dev.dev_jkizer.fct_patient_tag fpt
    ...
    and lower(fpt.tag_value) = 'Food as Medicine Class'
