...
create or replace transient table dw_dev.dev_jkizer.clinical_class_pt_two_one
    copy grants
...
with base_appointments as (
    select
        ...
        case when appointment_type_category like '2:1%' then 'PT-2:1' end as program,
        '2:1' as class_name,
    ...
    where (lower(appointment_type_category) like '2:1%')
    and
...
select
    ...
    case when fpt.tag_value = 'PT- 2:1' then tag_value end as tag_value,
