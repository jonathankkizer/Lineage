select
  coalesce(try_to_date(activity_date, 'MM/DD/YYYY'), try_to_date(activity_date, 'YYYY-MM-DD')) as activity_month,
  medicare_no as medicare_beneficiary_id, 
  risk_score_ab as mmr_risk_score,
  risk_score_d as mmr_part_d_risk_score,
...
coalesce(
 ...
 as report_date,
from airbyte_source_prod.wellcare_tx.mmr_demographics