...
teams as (
    ...
    select
        md5(cast(coalesce(cast(cr.id as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(cr.start_date_time as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as patient_communication_skey,
        ...
        null as talkdesk_phone_display_name,
        cr.organizer_user_display_name as "user",
        ...
        'Teams' as platform,
        cr.start_date_time as "timestamp",
        case
    ...
    from dw_dev.dev_jkizer.intmdt_teams_call_record cr
),
